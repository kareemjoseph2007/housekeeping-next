...
export default function Kitchen({ familyId, isOccupied, isUserOccupying, hasFamily, occupants }: {
  familyId: string;
  isOccupied: boolean;
  ...
  const toggleOccupancy = async () => {
    ...
    const result = await setRoomOccupancy(familyId, "kitchen", !isUserOccupying);
